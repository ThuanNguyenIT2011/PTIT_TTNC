...
class CheckPerformanceFrame(ttk.Frame):
    ...
    def _build_ui(self):
        ...
        self.preview_tree.column("stt", width=55, anchor="center")
        # self.preview_tree.column("language", width=90, anchor="center")
        self.preview_tree.column("text", width=145, anchor="w")
        self.preview_tree.column("pattern", width=145, anchor="w")
        self.preview_tree.column("text_length", width=145, anchor="center")
        self.preview_tree.column("pattern_length", width=145, anchor="center")
        self.preview_tree.column("pattern_in_text", width=145, anchor="center")
